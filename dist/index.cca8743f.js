...
})({"4pwu6":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0083b35fcca8743f";
...
},{}],"gboLj":[function(require,module,exports) {
...
},{"./mvc/controller":"6pxVS"}],"6pxVS":[function(require,module,exports) {
...
function init() {
    _model.updateUserName(_model.store.user.name);
    _viewDefault.default.render();
    getDefaultData();
...
async function getDefaultData() {
    try {
        ...
        data = data.filter((todo)=>todo.userId == _model.store.user.id
        );
        _model.store.todos = data;
        _todoListDefault.default.render(_model.store.todos, deleteStoreTodo, saveTodoEdit);
    } catch (err) {
        console.error(err);
    }
}
function deleteStoreTodo(todoTitle) {
    _model.store.todos = _model.store.todos.filter((i)=>i.title !== todoTitle
    );
    _todoListDefault.default.render(_model.store.todos, deleteStoreTodo, saveTodoEdit);
}
function saveTodoEdit(todoTitle, changedTitle) {
    let editedTodo = _model.store.todos.find((i)=>i.title == todoTitle
    );
    editedTodo.title = changedTitle;
    _todoListDefault.default.render(_model.store.todos, deleteStoreTodo, saveTodoEdit);
}

},{"./views/View":"5pg0K","./views/TodoList":"8LxZw","./model":"iHnUe","@parcel/transformer-js/src/esmodule-helpers.js":"c0Xo8"}],"5pg0K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ViewClass", ()=>ViewClass
);
...
class Todos extends _view.ViewClass {
    ...
    render(todos, deleteFunction, saveFunction) {
        ...
        for (let i of todos)todoList.innerHTML += `<div' class='todo'>
                    <div>${i.title}</div>
...
exports.default = new Todos();

},{"./View":"5pg0K","@parcel/transformer-js/src/esmodule-helpers.js":"c0Xo8","sweetalert":"gXHwi"}],"gXHwi":[function(require,module,exports) {
!function(t, e) {
...
},{}],"iHnUe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"c0Xo8"}]},["4pwu6","gboLj"], "gboLj", "parcelRequire94c2")

//# sourceMappingURL=index.cca8743f.js.map
