            ...
            function (require, module, exports) {
                ...
                async function getDefaultData() {
                    try {
                        ...
                        data = data.filter(
                            (todo) => todo.userId == _model.store.user.id
                        )
                        _model.store.todos = data
                        _todoListDefault.default.render(
                            _model.store.todos,
                            deleteStoreTodo,
                            saveTodoEdit
                        )
                ...
                function deleteStoreTodo(todoTitle) {
                    _model.store.todos = _model.store.todos.filter(
                        (i) => i.title !== todoTitle
                    )
                    _todoListDefault.default.render(
                        _model.store.todos,
                ...
                function saveTodoEdit(todoTitle, changedTitle) {
                    let editedTodo = _model.store.todos.find(
                        (i) => i.title == todoTitle
                    )
