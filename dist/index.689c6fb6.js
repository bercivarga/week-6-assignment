...
*/ var OVERLAY_ID = '__parcel__error__overlay__'
        ...
        elKqW: [
            function (require, module, exports) {
                ...
                _store.retrieveDefaultTodos(
                    _store.store.user.id,
                    _renderingLogic.renderTodoList
                )
            },
            {
                '../store/store': 'cEhL8',
                '../js/renderingLogic': 'lhBDt',
                '../js/todoHandlers': '53PRm',
            },
        ],
        cEhL8: [
            function (require, module, exports) {
                ...
                function saveTodoEdit(todoTitle, changedTitle, renderFunction) {
                    let editedTodo = store.todos.find(
                        (i) => i.title == todoTitle
                    )
                ...
                function retrieveDefaultTodos(userId, renderFunction) {
                    fetch('https://jsonplaceholder.typicode.com/todos')
                        ...
                        .then((data) =>
                            data.filter((todo) => todo.userId == userId)
                        )
                        .then((data) => (store.todos = data))
                        .then(() => renderFunction(store.todos))
                }
            },
            { '@parcel/transformer-js/src/esmodule-helpers.js': 'c0Xo8' },
        ],
        c0Xo8: [
            function (require, module, exports) {
        ...
        '53PRm': [
            function (require, module, exports) {
                ...
                var _sweetalertDefault =
                    parcelHelpers.interopDefault(_sweetalert)
                ...
                function addEditButtonEventHandler() {
                    ...
                    for (let i of editButtonArray)
                        i.addEventListener('click', function () {
                            _renderingLogic.renderEditPopup(
                                i.parentElement.id,
                                _renderingLogic.renderEditPopup
                            )
                        })
                ...
                !(function (t, e) {
                    ...
                    return (function (t1) {
                        function e1(o) {
                            ...
                            return (
                                t1[o].call(r.exports, r, r.exports, e1),
                                (r.l = !0),
                                r.exports
                            )
                        }
                        ...
                        function (t4, e3, n4) {
                            ...
                            var o1 = n4(1)
                            ;(e3.CONFIRM_KEY = 'confirm'),
                                (e3.CANCEL_KEY = 'cancel')
                            var r1 = {
                                    visible: !0,
                                    text: null,
                                    value: null,
                        ...
                        function (t7, e6, n7) {
                            ...
                            var o = n7(1),
                                r = n7(3),
                                i1 = n7(0),
                                a = i1.default.OVERLAY,
                                s = i1.default.SHOW_MODAL,
                                c = i1.default.BUTTON,
                                l = i1.default.BUTTON_LOADING,
                                u = n7(5)
                        ...
                        function (t14, e13) {
                            t14.exports = function (t15) {
                                ...
                                var n = e14.protocol + '//' + e14.host,
                                    o =
                                        n +
                                        e14.pathname.replace(/\/[^\/]*$/, '/')
                                return t15.replace(
                                    /url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi,
                                    function (t, e15) {
                                        var r = e15
                                ...
                                !(function (n12) {
                                    ...
                                    function a3(t20, e) {
                                        for (; 3 === t20._state; )
                                            t20 = t20._value
                                        if (0 === t20._state)
                                            return void t20._deferreds.push(e)
                                        ;(t20._handled = !0),
                                            i3._immediateFn(function () {
                                                var n =
                                                    1 === t20._state
                                                        ? e.onFulfilled
                                                        : e.onRejected
                                    ...
                                    ;(i3.prototype.catch = function (t) {
                                        ...
                                        (i3.all = function (t22) {
                                            var e =
                                                Array.prototype.slice.call(t22)
                                        ...
                                        (i3._unhandledRejectionFn = function (
                                            t
                                        ) {
                                        ...
                                        (i3._setUnhandledRejectionFn =
                                            function (t) {
                                                i3._unhandledRejectionFn = t
                                            }),
                                        void 0 !== t19 && t19.exports
                                            ? (t19.exports = i3)
                                            : n12.Promise || (n12.Promise = i3)
                                })(this)
                        ...
                        function (t24, e21, n) {
                            ...
                            ;(e21.setTimeout = function () {
                                ...
                                (e21.clearTimeout = e21.clearInterval =
                                    function (t) {
                                        t && t.close()
                                    }),
                                ...
                                n(19),
                                (e21.setImmediate = setImmediate),
                                (e21.clearImmediate = clearImmediate)
                        },
                                    ...
                                    if (!t27.setImmediate) {
                                        var s,
                                            ...
                                            d =
                                                ...
                                                Object.getPrototypeOf(t27)
                                        ;(d = d && d.setTimeout ? d : t27),
                                            '[object process]' ===
                                            {}.toString.call(t27.process)
                                                ? (function () {
                                                      s = function (t) {
                                                          e23.nextTick(
                                                              function () {
                        ...
                        function (t39, e30, n23) {
                            ...
                            var o11 = n23(1),
                                r5 = n23(4),
                                i5 = n23(0),
                                a4 = i5.default.BUTTON,
                                s = i5.default.DANGER_BUTTON,
                                c = n23(3),
                                l = n23(2),
                                u = n23(6),
                                f = n23(5),
                                d1 = function (t40, e, n) {
                                    var r = e.text,
                                        ...
                                        d = e.className,
                                        p = e.closeModal,
                                        m = o11.stringToNode(l.buttonMarkup),
                                        b = m.querySelector('.' + a4),
                                        v = a4 + '--' + t40
                        ...
                        function (t44, e32, n) {
                            ...
                            var o13 = n(5),
                                ...
                                k = function (t) {
                                    o13.default.timer &&
                                        clearTimeout(o13.default.timer),
                                        t &&
                                            (o13.default.timer =
                        ...
                        function (t45, e33, n25) {
                            ...
                            e33.getOpts = function () {
                                ...
                                var o15 = l(n)
                                ;(n.buttons = r7.getButtonListOpts(o15)),
                                    delete n.button,
                                    (n.content = i6.getContentOpts(n.content))
                                var u = Object.assign({}, s4, c, n)
                                return (
                                    Object.keys(u).forEach(function (t) {
                                        a6.DEPRECATED_OPTS[t] &&
                                            a6.logDeprecation(t)
                                    }),
                                    u
                                )
